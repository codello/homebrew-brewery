cask 'font-thesansuhh' do
  ...
  url "https://gitlab.com/Codello/homebrew-brewery/raw/master/Resources/TheSansUHH/TheSansUHH_TTF_v1.003.zip?private_token=#{File.open(ENV['HOME'] + '/.gitlab-homebrew-token', 'rb') { |f| f.read }}"
  name 'TheSansUHH'
