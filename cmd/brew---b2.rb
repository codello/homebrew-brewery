...
#: `--b2`
#: 
#: Ensures that protected B2 resources can be downloaded properly. This means ensuring
#: that the environment variables `HOMEBREW_B2_KEY_ID` and `HOMEBREW_B2_APPLICATION_KEY`
#: are set.
